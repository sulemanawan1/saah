        ...
        currentIndex: _selectedIndex,
          ...
          items: [
            BottomNavigationBarItem(
              ...
              icon: Icon(Icons.home,color: AppTheme.DarkPastelGreen,),
              label: 'Home',
            ...
            BottomNavigationBarItem(
              icon: Icon(Icons.party_mode,color: AppTheme.DarkPastelGreen,),
              label: 'Scan',
            ),
            BottomNavigationBarItem(
              icon: Icon(Icons.person,color: AppTheme.DarkPastelGreen,),
              label: 'Profile',
            ),
          ],
        ),
